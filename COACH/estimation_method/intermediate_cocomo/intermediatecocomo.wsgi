...
# wsgi file for the COACH IntermediateCOCOMO microservice, to make it useable from Apache.
...
sys.path.append("/var/www/COACH/COACH/estimation_method/intermediate_cocomo")
...
application = intermediate_cocomo.IntermediateCOCOMO().ms
