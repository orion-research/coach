...
# wsgi file for the COACH CostEstimation microservice, to make it useable from Apache.
...
sys.path.append("/var/www/COACH/COACH/estimation_method/cost_estimation")
...
application = cost_estimation.CostEstimation().ms
