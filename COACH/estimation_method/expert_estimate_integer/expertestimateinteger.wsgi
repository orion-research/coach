...
# wsgi file for the COACH ExpertEstimateInteger microservice, to make it useable from Apache.
# The script should be in the same directory as the Python file it imports.

import os
import sys

sys.path.append("/var/www/COACH/COACH/estimation_method/expert_estimate_integer")
...
application = expert_estimate_integer.ExpertEstimateInteger().ms
