...
# wsgi file for the COACH BasicCOCOMO microservice, to make it useable from Apache.
...
sys.path.append("/var/www/COACH/COACH/estimation_method/basic_cocomo")
...
application = basic_cocomo.BasicCOCOMO().ms
