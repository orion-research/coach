...
# wsgi file for the COACH AuthenticatioinService microservice, to make it useable from Apache.
...
from COACH.framework.AuthenticatioinService import AuthenticatioinService
...
application = AuthenticationService().ms
