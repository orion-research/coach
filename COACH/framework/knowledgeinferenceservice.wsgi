...
# wsgi file for the COACH KnowledgeInferenceService microservice, to make it useable from Apache.
...
application = KnowledgeInferenceService(os.path.normpath("/var/www/COACH/COACH/development_settings.json"),
