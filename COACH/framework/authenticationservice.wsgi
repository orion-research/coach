...
# wsgi file for the COACH AuthenticationService microservice, to make it useable from Apache.
...
application = AuthenticationService(os.path.normpath("/var/www/COACH/COACH/development_settings.json"),
